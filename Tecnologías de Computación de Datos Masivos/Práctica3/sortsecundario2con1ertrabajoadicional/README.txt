Programa SortSecundario2

Instrucciones para su compilación y ejecución

NOTA: Hasta donde he llegado, la compilación y ejecución sería exactamente igual que con el primer
      SortSecundario
...
4. Se puede ejecutar en local seleccionando la clase principal donde está el main, en nuestro
   ...
   4.2. Aún dentro de la misma pestaña en Program Arguments:
   		...
   		-files country_codes.txt -jt local part-m-* directorio_de_salida
...
5. Para ejecutarlo en el clúster tendremos que subir el .jar creado anteriormente y los ficheros de 
   ...
   subidos y dentro del sistema hdfs y no sería necesario volver a repetir estos pasos):
   	...
   	5.1. sortsecundario2-0.0.1-SNAPSHOT.jar
   	5.2. part-m-*
...
9. Tras ello ya podemos ejecutarlo en el clúster con:
	...
	9.1. $yarn jar sortsecundario2-0.0.1-SNAPSHOT.jar part-m-* salidaPrograma7
...
11. En la caja de texto del explorador ponemos /user/hdmaster/salidaPrograma7
